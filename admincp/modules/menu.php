...
<div class="col c-2 m-2 l-2">
     <div class="menu">
            <ul>
                 ...
                 <li><a href="index.php?action=qllsp&query=dangxuat"><i class="fa-solid fa-arrow-right-from-bracket" style="color: #dbdbdb;"></i>Đăng xuất</a></li>
