<?php
      ...
      if(isset($_POST['themsp']) )
      {
          ...
          $sql_them = "INSERT INTO sanpham (tensp,id_hangsx,hinhanh,giaban,khuyenmai,thongso)
           VALUES ('".$tensp."','".$hangsx."','".$hinhanh."', '".$giaban."','".$khuyenmai."','".$thongso."')";
          ...
          if($hinhanh !='')
          {
              ...
              $sql_sua = "UPDATE sanpham SET tensp='".$tensp."', id_hangsx='".$hangsx."',hinhanh ='".$hinhanh."',
               giaban='".$giaban."',khuyenmai='".$khuyenmai."', thongso='".$thongso."'  WHERE id_sanpham  = '$_GET[idsp]'";
