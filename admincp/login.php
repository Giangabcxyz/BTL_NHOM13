<?php  
       ...
       if(isset($_POST['dangnhap']))
      {
        $taikhoan = $_POST['user'];
        $matkhau  = $_POST['pass'];
        $sqli = "SELECT * FROM admin WHERE username='".$taikhoan."' AND password='".$matkhau."' LIMIT 1";
...
<section class="forms-section">
	...
	<div class="forms">
	  <div class="form-wrapper is-active">
		<button type="button" id="s1" class="switcher switcher-login">
		  Login
		...
		<form class="form form-login" method="POST">
		  ...
		  <button type="submit" name="dangnhap" class="btn-login">Login</button>
		</form>
	  </div>
	  <div class="form-wrapper">
		<button type="button" id="s2" class="switcher switcher-signup">
       Sign Up
		  <span class="underline"></span>
		</button>
  ...
  <script>
	const switcher1 = document.getElementById('s1')
    const switcher2 = document.getElementById('s2')
	const switchers =[switcher1,switcher2];
